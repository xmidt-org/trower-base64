...
application, document it in the [README](https://github.com/Comcast/trower-base64/blob/master/README.md) or [wiki](https://github.com/Comcast/trower-base64/wiki)! This includes new features, additional variants of behavior and breaking changes.
